  ...
  return (
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden bg-background">
      ...
      <div className="absolute inset-0 z-0">
        ...
        <div className="absolute bottom-[-10%] right-[-10%] w-[40%] h-[40%] rounded-full bg-pink-500/20 blur-[120px] mix-blend-screen" />
      </div>
      ...
      >
        <div className="text-center mb-8">
          ...
          <p className="text-muted-foreground mt-2">Sign in to continue to TaskFlow</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <motion.button
            ...
            className="w-full bg-gradient-to-r from-primary to-pink-500 text-white font-medium py-3 rounded-xl hover:shadow-lg hover:shadow-primary/30 transition-all flex items-center justify-center"
          >
            {isSubmitting ? (
